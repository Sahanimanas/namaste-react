...
const Section = ({ title, description, isShow, setIsShow }) => {
    ...
    return (
        <div className="border border-black m-4">
            ...
            {isShow ? (
                <button
                    className="m-2 border borde-black bg-gray-600 p-2"
                    onClick={() => {
                        setIsShow(false)
                    }}
                >
    ...
    return (
        <>
            <Section
                ...
                isShow={sectionconfig=== "Service"}
                setIsShow={() =>
                    setSectionconfig("Service")
                }
